...
#make make sure to put in the api key
...
keywords_file = open("C:\\Users\\ariel\\Documents\\python_projects\\ask_a_scientist\\keywords.txt", "r")
keyword_list = keywords_file.readlines()
...
for keyword in keyword_list:
    ...
    df_results.to_csv ("C:\\Users\\ariel\\Documents\\python_projects\\ask_a_scientist\\"+f'{keyword}.csv','a', index = False, header=True)